...
@OpenAPIDefinition(
        ...
        info = @Info(
                ...
                description = "This is backend of electronic store developed by Pratik Saurav",
                version = "1.0V",
                contact = @Contact(
                        name = "Pratik Saurav",
                        email = "sauravpratik746@gmail.com",
                        url = "https://www.linkedin.com/in/pratik-saurav-309192199/"
                ),
                license = @License(
                        name = "OPEN License",
                        url = "https://www.linkedin.com/in/pratik-saurav-309192199/"
